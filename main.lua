...
local game = Game()
local version = ": 1.0a" --added by me (pedro), for making updating version number easier
...
if EID then
    ...
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_FROZEN_FOOD, "+1 Frozen heart.", "Frozen Food", "en_us")
    EID:addCollectible(mod.RepmTypes.Collectible_SIREN_HORNS, "When fully charged, Isaac begins to scream, stunning enemies.", "Siren Horns", "en_us")
    EID:addCollectible(mod.RepmTypes.Collectible_HOW_TO_DIG, "Isaac is buried underground, monsters cannot attack him.", "How To Dig", "en_us")
    EID:addCollectible(mod.RepmTypes.Collectible_BATTERED_LIGHTER, "Lights fires.", "Battered Lighter", "en_us")
    EID:addCollectible(mod.RepmTypes.Collectible_HOLY_LIGHTER, "Reverse transformation.", "Holy Lighter", "en_us")
    EID:addCollectible(mod.RepmTypes.Collectible_PORTAL_D6, "When used, it sucks in all pickups and objects, after repeated use it changes them and scatters them across different rooms of the floor", "Portal D6", "en_us")
--ru
    ...
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_LIKE, "Когда Айзек проигрывает 'Like' анимацию - прибавка к характеристикам.", "Лайк", "ru")
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_SALAMI, "Дает +0,50 к скорости, урону, дальности, удаче и +0,27 слезам.", "Салями", "ru")
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_BOOK_OF_TAILS, "Гарантировано создаёт подпольную команту «Я ошибка». # Снижает вероятность сделки дьявола и ангела.", "Книга сказок", "ru")
    ...
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_LOST_SHROOM, "Дает 1 сердце души # накладывает яд случайному врагу в комнате.", "Потерянный гриб", "ru")
    ...
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_STRAWBERRY_MILK, "Создает лужи под врагами, если враг наступит на лужу, то окаменеет", "Клубничное молоко", "ru")
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_HOLY_SHELL, "При использовании выпускает 4 святых луча как: +.", "Святая оболочка", "ru")
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_LEAKY_BUCKET, "Иногда создает лужу под Айзеком, которая окаменевает врагов.", "Дырявое ведро", "ru")
    ...
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_PINK_STRAW, "On use, inflicts random debuff on enemies in the room.", "Pink straw", "ru")
    ...
    EID:addCollectible(mod.RepmTypes.COLLECTIBLE_DILIRIUM_EYE, "Есть шанс выстрелить 5 слезами #Шанс не зависит от удачи.", "Глаз сумашествия", "ru")
    EID:addCollectible(mod.RepmTypes.Collectible_HOLY_OTMICHKA, "Есть шанс превратить любой сундук в священный сундук.", "Святая отмычка", "ru")
    EID:addCollectible(mod.RepmTypes.Collectible_FLOWER_TEA, "Дает 0,60 урона, дальность 0,50 # Снижает скорострельность на 0,20.", "Цветочный чай", "ru")
    ...
    EID:addCollectible(mod.RepmTypes.Collectible_SANDWICH, "Дает 0,50 урона и 0,09 слез.", "Бутерброд", "ru")
    ...
    EID:addCollectible(mod.RepmTypes.Collectible_HOW_TO_DIG, "Исаакзакапывается под землю #Монстры не могут на него напасть.", "Как копать", "ru")
    EID:addCollectible(mod.RepmTypes.Collectible_BATTERED_LIGHTER, "Зажигает костры", "Потрепанная зажигалка", "ru")
    EID:addCollectible(mod.RepmTypes.Collectible_HOLY_LIGHTER, "Обратная трансформация", "Святая зажигалка", "ru")
    EID:addCollectible(mod.RepmTypes.Collectible_PORTAL_D6, "При использовании засасывает все пикапы и предметы, после повторного применения изменяет их и разбрасывает по разным комнатам этажа.", "Портальный Д6", "ru")
